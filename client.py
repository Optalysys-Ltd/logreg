...
CLIENT_STORAGE_PATH = "client_storage"
SERVER_STORAGE_PATH = "server_storage"
CRYPTO_FILE_PATH = os.path.join("client_storage","public_data")
SECRET_DATA_PATH = os.path.join("client_storage", "secret_data")
PUBLIC_DATA_PATH = os.path.join("server_storage", "public_data")
...
def cleanup():
    ...
    """
    try:
        shutil.rmtree(CRYPTO_FILE_PATH)
    except OSError:
        pass
    try:
        ...
        pass
    try:
        shutil.rmtree(SECRET_DATA_PATH)
    except OSError:
        pass
    os.mkdir(SECRET_DATA_PATH)
    os.mkdir(PUBLIC_DATA_PATH)
    os.mkdir(CRYPTO_FILE_PATH)
    pass
